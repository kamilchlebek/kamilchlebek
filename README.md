...
- Knows when code is good enough
- Focuses on providing business value on time
- Self-sufficient - truly respects the time of other team members
- Likes to surround himself with smarter people
- Digs down deep to the root cause of an issue

#### Attitude to software development

> Programming is meant to solve problems, it is not an art per se.
